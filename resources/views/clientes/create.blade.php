                                ...
                                <div class="mb-6 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        <select
                                            ...
                                            <option value="{{ $item->id }}" @if (old('materia_id') == $item->id) selected @endif >{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="mb-6 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        <select
                                            ...
                                            <option value="{{ $item->id }}" @if (old('juzgado_id') == $item->id) selected @endif >{{ $item->name }}</option>
                                            @endforeach
                                        </select>
