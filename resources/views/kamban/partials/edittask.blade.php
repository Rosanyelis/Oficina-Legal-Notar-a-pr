                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row g-3">
                                    ...
                                    <div class="form-floating form-floating-outline mb-5 col-md-4">
                                        <select class="select2 select2-label form-select" id="label_update" name="priority">
                                    ...
                                    <div class="w-100"></div>
                                    <div class="form-floating form-floating-outline mb-5 col-md-4">
                                        <select class="form-select" id="billable_task_update" name="billable_task">
                                    ...
                                    <div class="form-floating form-floating-outline mb-5 col-md-4">
                                        <select class="form-select" id="event_calendar_update" name="event_calendar">
                                            <option>Seleccione</option>
                                            <option value="Si">Si</option>
