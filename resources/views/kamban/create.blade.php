@extends('layouts.app')
@section('title', 'Gestiones de Tableros Kamban - Crear')
@section('content')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Nueva Espacio de Trabajo o Tablero </h5>
                    ...
                    <div class="card-body">
                        <form class="needs-validation" action="{{ route('gestiones.store') }}" method="POST">
                            @csrf
                            <div class="row">
